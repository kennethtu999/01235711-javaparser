...
public class Neo4jConfig {
    ...
    @Value("${neo4j.connection.max-connection-pool-size:50}")
    private int maxConnectionPoolSize;

    @Value("${neo4j.connection.connection-acquisition-timeout:30}")
    private int connectionAcquisitionTimeout;

    @Value("${neo4j.connection.max-connection-lifetime:3600}")
    private int maxConnectionLifetime;

    @Value("${neo4j.connection.connection-timeout:30}")
